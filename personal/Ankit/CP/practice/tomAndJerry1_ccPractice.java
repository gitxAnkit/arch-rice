...
public class tomAndJerry1_ccPractice {
    ...
    public static void isPathPossible(int a, int b, int c, int d, int k, int count, String asf) {
        if (count == k && a == c && b == d) {
        ...
        isPathPossible(a - 1, b, c, d, k, count + 1, asf + "t");
        isPathPossible(a, b + 1, c, d, k, count + 1, asf + "r");
        isPathPossible(a + 1, b, c, d, k, count + 1, asf + "d");
        isPathPossible(a, b - 1, c, d, k, count + 1, asf + "l");
